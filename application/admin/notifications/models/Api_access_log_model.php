...
/**
 * Description of API Access Log Model
 *
 * @category admin
 *
 ...
 *
 * @class Api_access_log_model.php
 *
 * @path application\admin\notifications\models\Api_access_log_model.php
 *
 * @version 4.3
 *
 * @author CIT Dev Team
 ...
 * @date 02.11.2018
 */
class Api_access_log_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "mod_api_accesslog";
        $this->table_alias = "maa";
        $this->primary_key = "iAccessLogId";
        $this->primary_alias = "maa_access_log_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        if (is_array($fields)) {
            ...
            $this->db->select("maa.vRequestUri AS maa_request_uri");
            $this->db->select("maa.tInputParams AS maa_input_params");
            $this->db->select("maa.dAccessDate AS maa_access_date");
            $this->db->select("maa.vIPAddress AS maa_i_paddress");
            $this->db->select("maa.vPlatform AS maa_platform");
            $this->db->select("maa.vBrowser AS maa_browser");
        } else {
            $this->db->select("maa.iAccessLogId AS iAccessLogId");
            $this->db->select("maa.iAccessLogId AS maa_access_log_id");
            $this->db->select("maa.vRequestUri AS maa_request_uri");
            $this->db->select("maa.dAccessDate AS maa_access_date");
            $this->db->select("maa.vIPAddress AS maa_i_paddress");
            $this->db->select("maa.vPlatform AS maa_platform");
    ...
    {
        $list_config = array(
            "maa_request_uri" => array(
                "name" => "maa_request_uri",
                "table_name" => "mod_api_accesslog",
                "table_alias" => "maa",
                "field_name" => "vRequestUri",
                "source_field" => "maa_request_uri",
                "display_query" => "maa.vRequestUri",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Request URI",
                "label_lang" => $this->lang->line('API_ACCESS_LOG_REQUEST_URI'),
                "width" => 200,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "maa_input_params" => array(
                "name" => "maa_input_params",
                "table_name" => "mod_api_accesslog",
                "table_alias" => "maa",
                "field_name" => "tInputParams",
                "source_field" => "maa_input_params",
                "display_query" => "maa.tInputParams",
                "entry_type" => "Table",
                "data_type" => "text",
                "show_in" => "Both",
                "type" => "textarea",
                "align" => "left",
                "label" => "Input Params",
                "label_lang" => $this->lang->line('API_ACCESS_LOG_INPUT_PARAMS'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "php_func" => "makeAPIParamsLink",
            ),
            "maa_access_date" => array(
                "name" => "maa_access_date",
                "table_name" => "mod_api_accesslog",
                "table_alias" => "maa",
                "field_name" => "dAccessDate",
                "source_field" => "maa_access_date",
                "display_query" => "maa.dAccessDate",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date_and_time",
                "align" => "left",
                "label" => "Access Date",
                "label_lang" => $this->lang->line('API_ACCESS_LOG_ACCESS_DATE'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "maa_i_paddress" => array(
                "name" => "maa_i_paddress",
                "table_name" => "mod_api_accesslog",
                "table_alias" => "maa",
                "field_name" => "vIPAddress",
                "source_field" => "maa_i_paddress",
                "display_query" => "maa.vIPAddress",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "IP Address",
                "label_lang" => $this->lang->line('API_ACCESS_LOG_IP_ADDRESS'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "maa_platform" => array(
                ...
                "source_field" => "maa_platform",
                "display_query" => "maa.vPlatform",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Platform",
                "label_lang" => $this->lang->line('API_ACCESS_LOG_PLATFORM'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "maa_browser" => array(
                ...
                "table_alias" => "maa",
                "field_name" => "vBrowser",
                "source_field" => "maa_browser",
                "display_query" => "maa.vBrowser",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "Browser",
                "label_lang" => $this->lang->line('API_ACCESS_LOG_BROWSER'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    /**
     * insertAccessLog method is used to insert data records for this module.
     * @param string $data contains acces log data.
     */
    public function insertAccessLog($data)
    {
        $rows = $this->db->insert_batch($this->table_name, $data);
        //echo $this->db->last_query();exit;
        return $rows;
    }
    
    /**
     * deleteAccessLog method is used to delete data records of particular date from this module.
     * @param string $date contains acces log data.
     */
    public function deleteAccessLog($date)
    {
        $this->db->where("DATE(dAccessDate) = '$date'", FALSE, FALSE);
        $this->db->delete("mod_api_accesslog");
    }
}
