...
class Delete_account extends Cit_Controller
{
    ...
    public function start_delete_account($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            ...
            {
                $input_params = $this->delete_query_tables($input_params);
                $input_params = $this->delete_relation_tables($input_params,'abusive_reports');
                $input_params = $this->delete_relation_tables($input_params,'blocked_user');
                $input_params = $this->delete_relation_tables($input_params,'notification');
                $input_params = $this->delete_relation_tables($input_params,'friends');
                $input_params = $this->delete_relation_tables($input_params,'ride');
                $condition_res = $this->is_deleted($input_params);  
                if ($condition_res["success"])
                {
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function delete_query_tables($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->users_model->delete_query_tables($params_arr, $where_arr);
        }
        catch(Exception $e)
        {
            $success = 0;
        ...
        $input_params["delete_relation_tables"] = $this->block_result["data"];
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function delete_relation_tables($input_params = array(),$table_name ='')
    {
        ...
        try
        {
            ...
            $this->block_result = $this->users_model->delete_relation_tables($params_arr, $where_arr);
        }
        catch(Exception $e)
        {
            $success = 0;
